...
async function fetchData(){
  ...
  try{
    ...
    const participationId=route.params.id
    ...
    const {data}=await api.get(
      `/settings/participations/${participationId}/edit`
    )

    selectedParticipation.value = data.selectedParticipation ?? null
    const participation=data.selectedParticipation
    ...
    formData.season_id=participation?.season_id ?? null
    formData.tournament_id=participation?.tournament_id ?? null
    formData.team_id=participation?.team_id ?? null
    formData.sponsor_id=participation?.sponsor_id ?? null
    formData.stadium_id=participation?.stadium_id ?? null
...
async function saveChanges(){
  ...
  try{
    ...
    const {data}=await api.put(
      `/settings/participations/${participationId}`,
      payload
    )
